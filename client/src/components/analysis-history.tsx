              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2">
                    <TypeIcon className="w-4 h-4 mt-0.5 shrink-0 text-muted-foreground" />
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1">
                        <span className="text-sm font-medium truncate block">{analysis.title}</span>
                        <ScoreIndicator score={analysis.overallScore} status={analysis.status} />
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        <span className="text-xs text-muted-foreground capitalize">{analysis.type}</span>
                        {analysis.overallScore !== null && analysis.overallScore !== undefined && (
                          <span className="text-xs text-muted-foreground">{analysis.overallScore}/100</span>
                        )}
                      </div>
                    ...
                    <button
                      ...
                      className="invisible group-hover:visible p-1 rounded-md text-muted-foreground"
